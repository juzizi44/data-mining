...
D3.to_csv('data/D3.csv',header=None)
X = D3.iloc[:,:-1]
y = D3.iloc[:,-1]
...
plt.savefig('./img/svm_wine_confusion_matrix.eps', format='eps', dpi=100, bbox_inches='tight')
plt.show()
plt.close()
...
plt.savefig('./img/svm_wine_evaluation_metrics.eps', format='eps', dpi=1000, bbox_inches='tight')
plt.show()
plt.close()
#%%
